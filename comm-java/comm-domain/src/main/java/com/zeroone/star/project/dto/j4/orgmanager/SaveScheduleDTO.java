...
public class SaveScheduleDTO {
    @ApiModelProperty(value = "排班id", example = "102022122394000332", required = true)
    @NotBlank(message = "排班id不能为空")
    private String scheduleId;        // 排班id（必填）
    ...
    @ApiModelProperty(value = "排班周期", example = "2", required = true)
