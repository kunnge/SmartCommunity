#pragma once
#ifndef _YARREARS_REMINDERSDTO_H_
#define _YARREARS_REMINDERSDTO_H_
...
添加登记欠缴
*/
class YArrears_RemindersAddDTO : public oatpp::DTO
{
	DTO_INIT(YArrears_RemindersAddDTO, DTO);

	//// 编号
	//API_DTO_FIELD_DEFAULT(UInt64, ofc_id, ZH_WORDS_GETTER("payremind.field.ofc_id"));
	// 小区分片字段
