 ...
 */
class GetVehicleFeeApiClient : public oatpp::web::client::ApiClient // 2 继承这个类
{
...
class GetPaymentRecordsApiClient : public oatpp::web::client::ApiClient // 2 继承这个类
{
	// 3 定义ApiClient控制器使用宏---开始
#include OATPP_CODEGEN_BEGIN(ApiClient)
 ...
 * 书写示例ApiClient来演示定义声明式服务
 */
class GetPaymentDetailedRecordApiClient : public oatpp::web::client::ApiClient // 2 继承这个类
{
	// 3 定义ApiClient控制器使用宏---开始
#include OATPP_CODEGEN_BEGIN(ApiClient)
...
class GetFeeModificationRecordsApiClient : public oatpp::web::client::ApiClient // 2 继承这个类
{
	// 3 定义ApiClient控制器使用宏---开始
#include OATPP_CODEGEN_BEGIN(ApiClient)
